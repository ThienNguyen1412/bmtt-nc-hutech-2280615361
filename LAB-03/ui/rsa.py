...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(540, 40, 101, 23))
        ...
        self.label_3.setGeometry(QtCore.QRect(80, 180, 61, 16))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(460, 110, 81, 16))
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(160, 100, 271, 71))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(160, 180, 271, 71))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.txt_info = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(530, 100, 271, 71))
        self.txt_info.setObjectName("txt_info")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(530, 180, 271, 71))
        self.txt_sign.setObjectName("txt_sign")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(170, 280, 75, 23))
        ...
        self.btn_verify.setGeometry(QtCore.QRect(690, 280, 75, 23))
